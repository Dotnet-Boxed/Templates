namespace MvcBoilerplate
{
    ...
    public partial class Startup
    {
        ...
        private static void UseStrictTransportSecurityHttpHeader(IApplicationBuilder application)
        {
        ...
        /// </summary>
        /// <param name="application">The application.</param>
        private static void UsePublicKeyPinsHttpHeader(IApplicationBuilder application)
        {
