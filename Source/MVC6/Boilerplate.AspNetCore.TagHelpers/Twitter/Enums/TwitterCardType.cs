namespace Boilerplate.AspNetCore.TagHelpers.Twitter
{
    ...
    public enum TwitterCardType
    {
        ...
        /// deliver your rich media to users across the globe. Twitter must approve the use of the player card, find
        /// out more below.
        ...
        /// <summary>
        /// The Product Card is a great way to represent product and retail items on Twitter. This Card type is
        /// designed to showcase your products via an image, a description, and allow you to highlight two other key
