namespace Boilerplate.Web.Mvc.Twitter
{
    ...
    /// </summary>
    public class SummaryLargeImageTwitterCard : TwitterCard
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="SummaryLargeImageTwitterCard" /> class.
        /// </summary>
        ...
        public SummaryLargeImageTwitterCard(string username)
            : base(username)
        {
        }
