namespace Boilerplate.Web.Mvc.OpenGraph
{
    ...
    {
        private readonly string resterauntUrl;
        ...
        /// <summary>
        /// Gets the URL to the page about the resteraunt who wrote the menu. This URL must contain profile meta tags <see cref="OpenGraphResteraunt"/>.
        /// </summary>
        public string ResterauntUrl { get { return this.resterauntUrl; } }
