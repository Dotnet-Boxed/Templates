namespace Boilerplate.Web.Mvc.OpenGraph
{
    ...
    /// </summary>
    public class OpenGraphResterauntMenuItem : OpenGraphMetadata
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenGraphResterauntMenuItem" /> class.
        /// </summary>
        ...
        public OpenGraphResterauntMenuItem(string title, OpenGraphImage image, string sectionUrl, string url = null)
