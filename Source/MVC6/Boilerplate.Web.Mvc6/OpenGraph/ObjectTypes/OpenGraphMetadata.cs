namespace Boilerplate.Web.Mvc.OpenGraph
{
    ...
    {
        private readonly List<OpenGraphMedia> media;
        ...
        public OpenGraphMetadata(string title, OpenGraphImage image, string url = null)
        {
            ...
            this.title = title;
            this.url = url;
            this.media = new List<OpenGraphMedia>();
        ...
        /// </summary>
        public IEnumerable<OpenGraphAudio> Audio { get { return this.media.OfType<OpenGraphAudio>(); } }
        ...
        /// </summary>
        public IEnumerable<OpenGraphImage> Images { get { return this.media.OfType<OpenGraphImage>(); } }
        ...
        /// </summary>
        public ICollection<OpenGraphMedia> Media { get { return this.media; } }
        ...
        /// </summary>
        public IEnumerable<OpenGraphVideo> Videos { get { return this.media.OfType<OpenGraphVideo>(); } }
