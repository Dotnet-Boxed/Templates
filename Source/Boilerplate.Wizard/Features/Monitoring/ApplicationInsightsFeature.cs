namespace Boilerplate.Wizard.Features
{
    ...
    public class ApplicationInsightsFeature : BinaryChoiceFeature
    {
        ...
        protected override async Task AddFeature()
        {
            ...
            await this.ProjectService.EditCommentInFile(this.Id + "-On", EditCommentMode.LeaveCodeUnchanged, @"Startup.ContentSecurityPolicy.cs");
            await this.ProjectService.EditCommentInFile(this.Id + "-Off", EditCommentMode.DeleteCode, @"Startup.ContentSecurityPolicy.cs");
        ...
        protected override async Task RemoveFeature()
        {
            ...
            await this.ProjectService.EditCommentInFile(this.Id + "-On", EditCommentMode.DeleteCode, @"Startup.ContentSecurityPolicy.cs");
            await this.ProjectService.EditCommentInFile(this.Id + "-Off", EditCommentMode.LeaveCodeUnchanged, @"Startup.ContentSecurityPolicy.cs");
