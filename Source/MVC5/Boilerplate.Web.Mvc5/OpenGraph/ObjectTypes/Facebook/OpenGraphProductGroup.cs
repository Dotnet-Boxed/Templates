namespace Boilerplate.Web.Mvc.OpenGraph
{
    ...
    public class OpenGraphProductGroup : OpenGraphMetadata
    {
        ...
        public OpenGraphProductGroup(string title, OpenGraphImage image)
            : base(title, image)
        {
        }
        ...
        public OpenGraphProductGroup(string title, OpenGraphImage image, string url)
        ...
        public override void ToString(StringBuilder stringBuilder)
        {
            ...
            stringBuilder.AppendMetaIfNotNull("product:retailer_group_id", this.RetailerGroupId);
        }
