namespace Boilerplate.Web.Mvc.OpenGraph
{
    ...
    public class OpenGraphPlace : OpenGraphMetadata
    {
        ...
        public OpenGraphPlace(string title, OpenGraphImage image, OpenGraphLocation location)
            : base(title, image)
        {
            if (location == null)
            {
        ...
        /// <exception cref="System.ArgumentNullException">location is <c>null</c>.</exception>
        public OpenGraphPlace(string title, OpenGraphImage image, OpenGraphLocation location, string url)
