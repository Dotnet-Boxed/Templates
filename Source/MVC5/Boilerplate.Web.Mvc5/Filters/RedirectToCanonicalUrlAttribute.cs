namespace Boilerplate.Web.Mvc.Filters
{
    ...
    public class RedirectToCanonicalUrlAttribute : FilterAttribute, IAuthorizationFilter
    {
        ...
        /// <param name="ignoreControllers">The collection of controller names (Without the word 'Controller' on the end) to ignore.</param>
        public RedirectToCanonicalUrlAttribute(bool appendTrailingSlash, bool lowercaseUrls, IEnumerable<string> ignoreControllers)
        {
